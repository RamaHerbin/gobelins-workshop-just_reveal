...
void main() {
   ...
   //prePos += noise * normal / 5.;
   prePos += noise * normal / depthNoise; // test pour rajouter un curseur de depth noise
   
   vec4 pos = projectionMatrix * modelViewMatrix * vec4( prePos, 0.7);
   gl_Position = pos;
}
